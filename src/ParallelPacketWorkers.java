...
public class ParallelPacketWorkers {
 ...
 */
class ParallelDataPacketWorker implements PacketWorker{
    ...
    public ParallelDataPacketWorker(ConcurrentHashMap<Integer, Boolean> PNG,
            ConcurrentHashMap<Integer, IntervalSkipList> R,
            PaddedPrimitiveNonVolatile<Boolean> done,
...
class ParallelConfigPacketWorker implements PacketWorker{
    ...
    AtomicInteger numPacketsInFlight;
    ConcurrentHashMap<Integer, HashMap<Integer, Boolean>> cache;
    public ParallelConfigPacketWorker(ConcurrentHashMap<Integer, Boolean> PNG,
            ConcurrentHashMap<Integer, IntervalSkipList> R,
            PaddedPrimitiveNonVolatile<Boolean> done,
            LamportQueue<Packet> queue,
            AtomicInteger numPacketsInFlight,
